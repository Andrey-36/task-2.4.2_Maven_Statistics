...
class StatsServiceTest {
    ...
    void shouldMaxMonthSales() {
        ...
        long actual = service.calculateMaxMonthSales(sales);
    ...
    void shouldcalculateMinMonthSales() {
        ...
        long actual = service.calculateMinMonthSales(sales);

        assertEquals(expected, actual);
    }

    @Test
    void shouldCalculatSalesBelowAverage() {
        StatsService service = new StatsService();
        int[] sales = {8, 15, 13, 15, 17, 20, 19, 20, 7, 14, 14, 18};
        int expected = 5;

        int actual = service.calculatSalesBelowAverage(sales);
